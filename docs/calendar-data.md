...
The upcoming meeting shows relative timing and a compact record-circle button beside its title, with the tooltip “Record this meeting.” That button records the displayed occurrence with its title and invitee details. The large Start recording button remains a standalone manual action. There is no secondary full-size recording button or “Record another” menu.
