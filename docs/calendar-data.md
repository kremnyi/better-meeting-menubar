...
The upcoming section lists today's remaining meetings. The first is shown in full — relative timing, calendar name, and a compact record-circle button beside its title, with the tooltip “Record this meeting.” That button records the displayed occurrence with its title and invitee details. Up to two more meetings appear as one-line time and title rows, followed by a muted “N more today” line that opens Calendar. Once today is done, the section reads “No more meetings today.” with a muted line naming the first meeting of tomorrow. The 24-hour read still feeds reminders and the menu-bar preview. The large Start recording button remains a standalone manual action. There is no secondary full-size recording button or “Record another” menu.
